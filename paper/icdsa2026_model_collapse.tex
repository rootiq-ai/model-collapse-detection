...
patterns~\cite{shumailov2024nature,dohmatob2025strong}. These errors accumulate
...
Table~\ref{tab:llama} shows the LLaMA~3-8B collapse progression.
...
Table~\ref{tab:gpt2} shows the GPT-2 results with confidence intervals across three
seeds.
...
``Tale of Tails'' framework~\cite{dohmatob2025strong}. Perplexity measures average
...
of synthetic data; their ``Tale of Tails'' insight---that rare patterns erode first
due to sampling variance---directly motivates our use of diversity metrics as
...
Schaeffer, R., Miranda, B., Koyejo, S.: Position: model collapse does not mean
what you think. In: Proceedings of the International Conference on Machine Learning
(ICML) (2025)
...
Dohmatob, E., Feng, Y., Kempe, J.: Strong model collapse. In: International
