...
% Detection points
\draw[blue, thick, ->] (axis cs:2,0.85) -- (axis cs:2,0.5);
\draw[red, thick, ->] (axis cs:4,0.71) -- (axis cs:4,0.5);
\legend{Distinct-1, 1/PPL (norm), 10\% threshold}
\end{axis}
\node[blue, font=\scriptsize] at (1.8, 0.8) {D-1};
\node[blue, font=\scriptsize] at (1.8, 0.5) {Gen 2};
\node[red, font=\scriptsize] at (4.2, 0.8) {PPL};
\node[red, font=\scriptsize] at (4.2, 0.5) {Gen 4};
\end{tikzpicture}
...
I. Shumailov \textit{et al.}, ``AI models collapse when trained on recursively generated data,'' \textit{Nature}, vol. 631, pp. 755--759, 2024.

\bibitem{schaeffer2025position}
R. Schaeffer \textit{et al.}, ``Position: Model Collapse Does Not Mean What You Think,'' \textit{arXiv:2503.03150}, 2025.

\bibitem{shumailov2023curse}
I. Shumailov \textit{et al.}, ``The Curse of Recursion,'' \textit{arXiv:2305.17493}, 2023.

\bibitem{gerstgrasser2024inevitable}
M. Gerstgrasser \textit{et al.}, ``Is Model Collapse Inevitable?'' in \textit{Proc. COLM}, 2024.
...
A. Radford \textit{et al.}, ``Language Models are Unsupervised Multitask Learners,'' OpenAI, 2019.
